...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'menus.findAll' }),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'menus.findOne' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'menus.create' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'menus.update' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'menus.remove' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
